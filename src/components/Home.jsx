    ...
    <Container className="mt-4">
      <Row>
        <Col className="d-none d-md-block p-0" xs={2}>
          ...
          >
            ...
            <div className="ma text-center ms-0">
              ...
              <div className="mt-4">
                ...
                <div>
                  <p className="mb-0 me-auto" style={{ fontSize: "0.8em" }}>
                    Espandi la tua rete
                  </p>
                </div>
          ...
          <div
            className="mt-2 rounded rounded-2 border border-1 border-secondary-subtle bg-white background-columns w-100"
            style={{ width: "280px" }}
          >
            <div className="d-flex flex-column mt-3">
              ...
              <div>
                <hr />
                <p className="text-secondary text-center cursor">
                  Scopri di più
                </p>
              </div>
            </div>
        ...
        <Col xs={12} md={10} lg={7} className="p-0">
          ...
          <Row className="justify-content-center w-100">
            <Col
              className="d-sm border border-1 border-secondary-subtle mb-1 mt-1 bg-white rounded col-md-6  p-2 ms-3"
              style={{ width: "90%" }}
            >
